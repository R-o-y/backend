...
// from ./dividesmart/bundled_static/prod/bundle
// to   ./dividesmart/bundled_static/dev/bundle
devConfig.output.path = path.resolve('./dividesmart/bundled_static/dev/bundle')
